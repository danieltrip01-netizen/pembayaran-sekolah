                            ...
                            <table class="tabel-bulan">
                                ...
                                <tbody>
                                    @foreach ($tabel as $row)
                                        <tr>
                                            <td class="td-bulan" style="height:12px">{{ $row['bulan'] }}</td>
                                            <td>
                                                {{ $loop->first && $row['aktif'] ? number_format($row['uang_sekolah'], 0, ',', '.') : '' }}
                                            </td>
                                            <td>
                                                {{ $loop->first && $row['aktif'] ? number_format($row['donatur'], 0, ',', '.') : '' }}
                                            </td>
                                            <td>{{ $loop->first && $row['aktif'] ? number_format($row['uang_sekolah'] - $row['donatur'] + $siswa->nominal_mamin, 0, ',', '.') : '' }}
                                            </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
